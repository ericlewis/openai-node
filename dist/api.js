...
const OpenAIApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createTranscription: async (file, model, prompt, responseFormat, temperature, options = {}) => {
            // verify required parameter 'file' is not null or undefined
...
const OpenAIApiFp = function (configuration) {
    ...
    return {
        ...
        async cancelFineTune(fineTuneId, options) {
            ...
            return (0, common_1.createRequestFunction)(localVarAxiosArgs, redaxios_1.default, base_1.BASE_PATH, configuration);
        },
        /**
         *
         * @summary Answers the specified question using the provided documents and examples.  The endpoint first [searches](/docs/api-reference/searches) over provided documents or files to find relevant context. The relevant context is combined with the provided examples and question to create the prompt for [completion](/docs/api-reference/completions).
         ...
         * @throws {RequiredError}
         */
        async createTranscription(file, model, prompt, responseFormat, temperature, options) {
...
class OpenAIApi extends base_1.BaseAPI {
     ...
     */
    createTranscription(file, model, prompt, responseFormat, temperature, options) {
        return (0, exports.OpenAIApiFp)(this.configuration).createTranscription(file, model, prompt, responseFormat, temperature, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Translates audio into into English.
